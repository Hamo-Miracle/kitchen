						...
						<tbody>
							...
							<tr>
								<td align="right" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: <?php echo $data['style']['color']; ?>" st-content="preheader">
									<?php printf( __( 'If you can not read this email, please <a class="hlite" style="text-decoration: none; color: %2$s" href="%1$s">click here</a>.', 'ipt_fsqm' ), $this->get_email_url(), $data['style']['accent_bg'] ); ?>
								</td>
							</tr>
							<!-- Spacing -->
							<tr>
