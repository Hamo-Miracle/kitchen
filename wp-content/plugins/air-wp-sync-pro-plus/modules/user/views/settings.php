<?php
/**
 * Display user module settings.
 *
 * @package Air_WP_Sync_Pro
 */

/**
 * Display the user settings: default role, language and user notification.
 *
...
<table class="form-table">
	...
	<?php endif; ?>
	<tr valign="top">
		<th scope="row"><?php esc_html_e( 'Send User Notification', 'air-wp-sync' ); ?></th>
		<td>
			...
			<label for="send_user_notification"><?php esc_html_e( 'Send the new user an email about their account.', 'air-wp-sync' ); ?></label>
		</td>
	</tr>
</table>
	<?php
