...
require_once AIR_WP_SYNC_PRO_PLUGIN_DIR . 'modules/term/class-air-wp-sync-term-helpers.php';
require_once AIR_WP_SYNC_PRO_PLUGIN_DIR . 'modules/term/class-air-wp-sync-term-importer.php';
require_once AIR_WP_SYNC_PRO_PLUGIN_DIR . 'modules/term/destinations/class-air-wp-sync-term-destination.php';
require_once AIR_WP_SYNC_PRO_PLUGIN_DIR . 'modules/term/destinations/class-air-wp-sync-term-meta-destination.php';
...
class Air_WP_Sync_Term_Module extends Air_WP_Sync_Abstract_Module {
	...
	public function register_styles_scripts() {
		...
		if ( is_object( $screen ) && 'airwpsync-connection' === $screen->id ) {
			wp_enqueue_script( 'air-wp-sync-term-hooks', plugins_url( 'modules/term/assets/js/hooks.js', AIR_WP_SYNC_PRO_PLUGIN_FILE ), array( 'air-wp-sync-admin' ), AIR_WP_SYNC_PRO_VERSION, false );
		}
	}
	...
	public function get_importer_instance( $post ) {
		return new Air_WP_Sync_Term_Importer( $post, $this, Air_WP_Sync_Services::get_instance()->get( 'airtable_api_client_class_factory' ), Air_WP_Sync_Services::get_instance()->get( 'filters' ) );
	}
	...
	public function register_destinations() {
		...
		new Air_WP_Sync_Term_Meta_Destination( new Air_WP_Sync_Markdown_Formatter( new Air_WP_Sync_Parsedown() ), Air_WP_Sync_Services::get_instance()->get( 'attachments_formatter' ) );
	}
