...
class Air_WP_Sync_Admin_Connection {
	...
	public function register_styles_scripts() {
		...
		if ( is_object( $screen ) && 'airwpsync-connection' === $screen->id ) {
			wp_enqueue_script( 'air-wp-sync-alpine', plugins_url( 'assets/js/alpinejs@3.10.2.min.js', AIR_WP_SYNC_PRO_PLUGIN_FILE ), false, AIR_WP_SYNC_PRO_VERSION, false );
			wp_enqueue_script( 'air-wp-sync-admin-filters', plugins_url( 'assets/js/filters/main.js', AIR_WP_SYNC_PRO_PLUGIN_FILE ), array( 'wp-i18n' ), AIR_WP_SYNC_PRO_VERSION, false );
			wp_set_script_translations( 'air-wp-sync-admin-filters', 'air-wp-sync', AIR_WP_SYNC_PRO_PLUGIN_DIR . 'languages/' );

			wp_enqueue_script( 'air-wp-sync-admin', plugins_url( 'assets/js/admin-page.js', AIR_WP_SYNC_PRO_PLUGIN_FILE ), array( 'air-wp-sync-alpine', 'jquery-ui-tooltip', 'wp-hooks', 'air-wp-sync-admin-filters', 'wp-i18n' ), AIR_WP_SYNC_PRO_VERSION, false );
			...
			wp_enqueue_script( 'air-wp-sync-admin-metabox-mapping', plugins_url( 'assets/js/metabox-mapping/main.js', AIR_WP_SYNC_PRO_PLUGIN_FILE ), array( 'air-wp-sync-admin', 'wp-i18n' ), AIR_WP_SYNC_PRO_VERSION, false );
			wp_set_script_translations( 'air-wp-sync-admin-metabox-mapping', 'air-wp-sync', AIR_WP_SYNC_PRO_PLUGIN_DIR . 'languages/' );

			wp_enqueue_style( 'air-wp-sync-ui', plugins_url( 'assets/js/air-wp-sync-ui/library/index.css', AIR_WP_SYNC_PRO_PLUGIN_FILE ), false, AIR_WP_SYNC_PRO_VERSION );
	...
	public function add_meta_boxes() {
		new Air_WP_Sync_Metabox_Global_Settings( Air_WP_Sync_Services::get_instance()->get( 'filters' ) );
